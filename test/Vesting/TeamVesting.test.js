...
contract('TeamVesting', function([_, owner, ]) {
    const amount = new BigNumber(1000);
    const beneficiary = '0xf51E1b1000aF9f7fB1CE1124f1dEBAB4C89AAE1D';

    beforeEach(async function() {

        this.token = await MintableToken.new({ from: owner });
        this.vesting = await TeamVesting.new(latestTime() + duration.minutes(1), { from: owner });
